        ...
        <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center p-4" onClick={() => setSelectedBooking(null)}>
          <div className="bg-white rounded-lg max-w-lg w-full max-h-[80vh] overflow-y-auto p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div>
                <p className="text-[11px] uppercase tracking-[0.1em] mb-1" style={{ fontFamily: "var(--font-body)", color: "#5A3A2E80" }}>Status</p>
                <select
              ...
              <div>
                <p className="text-[11px] uppercase tracking-[0.1em] mb-1" style={{ fontFamily: "var(--font-body)", color: "#5A3A2E80" }}>Pickup</p>
              ...
              <div>
                <p className="text-[11px] uppercase tracking-[0.1em] mb-1" style={{ fontFamily: "var(--font-body)", color: "#5A3A2E80" }}>Cake</p>
            ...
            {bookingDetail.data.customMessage && (
              <div className="mb-4">
                <p className="text-[11px] uppercase tracking-[0.1em] mb-1" style={{ fontFamily: "var(--font-body)", color: "#5A3A2E80" }}>Custom Message</p>
            ...
            {bookingDetail.data.customRequest && (
              <div className="mb-4">
                <p className="text-[11px] uppercase tracking-[0.1em] mb-1" style={{ fontFamily: "var(--font-body)", color: "#5A3A2E80" }}>Custom Request</p>
                <p className="text-sm p-2 rounded" style={{ fontFamily: "var(--font-body)", color: "#5A3A2E", backgroundColor: "#5A3A2E05" }}>
                  {bookingDetail.data.customRequest}
                </p>
              </div>
          ...
          <table className="w-full">
            <thead>
              <tr style={{ backgroundColor: "#5A3A2E05", fontFamily: "var(--font-body)" }}>
                <th className="text-left text-[11px] uppercase tracking-[0.1em] px-5 py-3 font-medium" style={{ color: "#5A3A2E80" }}>Booking #</th>
                <th className="text-left text-[11px] uppercase tracking-[0.1em] px-5 py-3 font-medium" style={{ color: "#5A3A2E80" }}>Customer</th>
                <th className="text-left text-[11px] uppercase tracking-[0.1em] px-5 py-3 font-medium" style={{ color: "#5A3A2E80" }}>Cake</th>
                <th className="text-left text-[11px] uppercase tracking-[0.1em] px-5 py-3 font-medium" style={{ color: "#5A3A2E80" }}>Pickup</th>
